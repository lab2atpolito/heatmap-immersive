Shader "Unlit/HeatmapShader"
{
  Properties
  {
    ...
    _Color0("Color 0",Color) = (0,0,0,1)
      ...
      _NumberOfUsers("Number of users", Range(1,100))=15
  }
    SubShader
    {
      ...
      Pass
      {
        ...
        float _HitCount = 0; //number of gaze data
        float _Hits[1022];
        float _TotalHits = 1;
        
        

        float _Intensities[511]; //insensity: how much that point was focused
